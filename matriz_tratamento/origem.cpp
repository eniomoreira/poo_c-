...
int main(){
    ...
    try{
        ...
        Matrix<double> m_erro1(-1, -3, 6); // FORÇANDO O ERRO
    }
    ...
    try{
        Matrix<double> m_erro2(-9,-9,2.7); //FORCANDO ERRO;
        ...
        m6(20,50) = 3; // FORCANDO ERRO;
        m6(1, 1) = 7; m6(1,2) = -3; m6(2, 1) = 3.6; m6(2, 2) = -2; m6(3, 1) = 4;         
